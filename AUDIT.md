...
| Repo-owned workflow roles | `.github/workflows/architecture.yml` is supplemental enforcement and `.github/workflows/controller-release.yml` is release-only automation. Security scanners are supplemental signal, not product certification. | `.github/workflows/architecture.yml`, `.github/workflows/controller-release.yml`, remaining workflow set |
